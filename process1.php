...
function insertProcess($data){
			...
			if($result_insert_user){
				...
				$message .= '<tr><td height="100">&nbsp;</td><td><p style="font:15px Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:bold;margin:7px 0;color:#000000;">We are here to help.</p><p style="font:14px Helvetica Neue,Helvetica,Arial,sans-serif;color:#777777;margin:7px 0;padding:0;">With this you are invited to access TownWizard\'s <a target="_blank" href="http://www.townwizard.org/" style="font:14px Helvetica Neue,Helvetica,Arial,sans-serif;color:#1a1a1a;text-decoration:none;">Customer Self Service Portal</a>. By accessing this portal you can now track your requests online, access knoeledge base and join the community forums.</p></td><td>&nbsp;</td></tr>';
				...
				$message .= '<tr><td>&nbsp;</td><td><p style="font:15px Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:bold;margin:7px 0;color:#000000;">Please use following browsersfor account activation:</p><p style="font:15px Helvetica Neue,Helvetica,Arial,sans-serif;margin:7px 0;color:#000000;">Latest version of Google Chrome, Mozilla Firefox, Internet explorer 9,10</p></td><td>&nbsp;</td></tr>';
