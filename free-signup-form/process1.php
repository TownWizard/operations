...
function insertProcess($data){
			...
			if($result_insert_user){
				...
				$message .= $headercode; 
				$message .= '<tr><td>&nbsp;</td><td><p style="font:22px Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:bold;margin:0px 0 0 0;padding:0;color:#000;">Congratulations</p><p style="font:14px Helvetica Neue,Helvetica,Arial,sans-serif;color:#777777;margin:20px 0 5px 0;padding:0;">Thanks for signing up for your free local guide from TownWizard! Please click on [Click Here] button below within 24 hours to activate your guide.</p></td><td>&nbsp;</td></tr>';
...
function updateProcess($did){
		...
		if($result_insert_user){
				...
				$message .= '<tr><td height="100">&nbsp;</td><td> 
					...
					<tr><td style="font:14px Helvetica Neue,Helvetica,Arial,sans-serif;color:#777777;margin:7px 0;padding:0;vertical-align: top;">Guide Administration URL : </td><td><a target="_blank" href="http://'.$_REQUEST['gname'].'.townwizard.com/manage" style="font:14px Helvetica Neue,Helvetica,Arial,sans-serif;color:#1a1a1a;text-decoration:none;">http://'.$_REQUEST['gname'].'.townwizard.com/manage</a></td></tr>
