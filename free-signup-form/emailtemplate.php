										...
										<table width="650" border="0" align="center" cellpadding="0" cellspacing="0"><tbody>
											...
											<tr>
												<td height="50" colspan="2" >
													<table width="650" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" style="border:1px double #e3e3e3;padding:0;margin:0"><tbody>
														<tr>
															<td width="40">&nbsp;</td>
...
function mailfooter(){
	$footercode = '
					...
					<tr>
						<td align="center" valign="middle" colspan="2"><p style="font:15px Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:bold;margin:7px 0;color:#000000;">OUR ADDRESS & SOCIAL MEDIA DETAILS</p></td>

					</tr>
					<tr>
						<td height="20" align="center" colspan="2"  style="border-top:1px solid #e3e3e3"><p style="font:12px Helvetica Neue,Helvetica,Arial,sans-serif;margin:0;padding:0;color:#777777;text-decoration:none">2, Overhill Road, Suite 400, Scarsdale, NY 10583 , USA</p></td>
					</tr>
					<tr>
